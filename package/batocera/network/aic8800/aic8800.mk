...
AIC8800_VERSION = 80e7d448d9431f919860b3654f75500b06528c3f
...
define AIC8800_FIRMWARE_ETC_SDIO
	...
	cp -rf $(@D)/src/SDIO/driver_fw/fw/aic8800      $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO
	cp -rf $(@D)/src/SDIO/driver_fw/fw/aic8800D80   $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO
	cp -rf $(@D)/src/SDIO/driver_fw/fw/aic8800D80X2 $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO
	cp -rf $(@D)/src/SDIO/driver_fw/fw/aic8800DC    $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO
