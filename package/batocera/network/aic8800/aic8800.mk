...
AIC8800_VERSION = 5.0+git20260123.5f7be68d-3
...
define AIC8800_FIRMWARE_ETC_SDIO
	...
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800/*	     $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO/
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800D80/*   $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO/
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800D80X2/* $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO/
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800DC/*    $(TARGET_DIR)/lib/firmware/aic8800_fw/SDIO/
