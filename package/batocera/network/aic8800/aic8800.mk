...
AIC8800_VERSION = 2bf2dc64bedaf3f0fcbcc206125afa5da8b3835b
...
define AIC8800_FIRMWARE_ETC
	...
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800/*      $(TARGET_DIR)/lib/firmware/aic8800
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800D80/*   $(TARGET_DIR)/lib/firmware/aic8800
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800D80X2/* $(TARGET_DIR)/lib/firmware/aic8800
	cp -f $(@D)/src/SDIO/driver_fw/fw/aic8800DC/*    $(TARGET_DIR)/lib/firmware/aic8800
