...
define RETROSHOOTER_GUNS_INSTALL_TARGET_CMDS
  ...
  $(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/retroshooter-guns/batocera-retroshooter-calibrator        $(TARGET_DIR)/usr/bin/batocera-retroshooter-calibrator
  $(INSTALL) -m 0755 -D $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/retroshooter-guns/batocera-retroshooter-calibrator-daemon $(TARGET_DIR)/usr/bin/batocera-retroshooter-calibrator-daemon
endef
