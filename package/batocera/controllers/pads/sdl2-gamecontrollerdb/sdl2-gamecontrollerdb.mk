...
SDL2_GAMECONTROLLERDB_VERSION = 075c1549075ef89a397fd7e0663d21e53a2485fd
...
define SDL2_GAMECONTROLLERDB_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/pads/pads/sdl2-gamecontrollerdb/S98sdlctl_db $(TARGET_DIR)/etc/init.d/S98sdlctl_db
endef
