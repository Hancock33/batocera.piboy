...
define XPI_GAMECON_RPI_INSTALL_TARGET_CMDS
	$(TARGET_CC) -Wno-incompatible-pointer-types $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/pads/xpi_gamecon_rpi/volumed.c -o $(TARGET_DIR)/usr/sbin/volumed -L$(STAGING_DIR)/usr/lib -lpulse
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/pads/xpi_gamecon_rpi/S19piboy					$(TARGET_DIR)/etc/init.d/S19piboy
	...
	cp -pvr $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/controllers/pads/xpi_gamecon_rpi/roms/piboy $(TARGET_DIR)/usr/share/batocera/datainit/roms
endef
