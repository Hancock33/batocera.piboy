...
KODI_RESOURCE_LANGUAGE_DE_DE_DIR=$(TARGET_DIR)/usr/share/kodi/addons
...
define KODI_RESOURCE_LANGUAGE_DE_DE_INSTALL_TARGET_CMDS
	@mkdir -p $(KODI_RESOURCE_LANGUAGE_DE_DE_DIR)
	@cp -r $(@D)/$(KODI_RESOURCE_LANGUAGE_DE_DE_PLUGINNAME) $(KODI_RESOURCE_LANGUAGE_DE_DE_DIR)
endef
