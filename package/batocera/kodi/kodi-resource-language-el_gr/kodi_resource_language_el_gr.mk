...
KODI_RESOURCE_LANGUAGE_EL_GR_DIR=$(TARGET_DIR)/usr/share/kodi/addons
...
define KODI_RESOURCE_LANGUAGE_EL_GR_INSTALL_TARGET_CMDS
	@mkdir -p $(KODI_RESOURCE_LANGUAGE_EL_GR_DIR)
	@cp -r $(@D)/$(KODI_RESOURCE_LANGUAGE_EL_GR_PLUGINNAME) $(KODI_RESOURCE_LANGUAGE_EL_GR_DIR)
endef
