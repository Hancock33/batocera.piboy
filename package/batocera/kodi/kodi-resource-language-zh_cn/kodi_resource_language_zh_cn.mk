...
KODI_RESOURCE_LANGUAGE_ZH_CN_VERSION = 11.0.74
...
KODI_RESOURCE_LANGUAGE_ZH_CN_DIR=$(TARGET_DIR)/usr/share/kodi/addons
...
define KODI_RESOURCE_LANGUAGE_ZH_CN_INSTALL_TARGET_CMDS
	@mkdir -p $(KODI_RESOURCE_LANGUAGE_ZH_CN_DIR)
	@cp -r $(@D)/$(KODI_RESOURCE_LANGUAGE_ZH_CN_PLUGINNAME) $(KODI_RESOURCE_LANGUAGE_ZH_CN_DIR)
endef
