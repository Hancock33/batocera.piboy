...
KODI_RESOURCE_LANGUAGE_FR_FR_DIR=$(TARGET_DIR)/usr/share/kodi/addons
...
define KODI_RESOURCE_LANGUAGE_FR_FR_INSTALL_TARGET_CMDS
	@mkdir -p $(KODI_RESOURCE_LANGUAGE_FR_FR_DIR)
	@cp -r $(@D)/$(KODI_RESOURCE_LANGUAGE_FR_FR_PLUGINNAME) $(KODI_RESOURCE_LANGUAGE_FR_FR_DIR)
endef
