...
KODI_RESOURCE_LANGUAGE_TR_TR_DIR=$(TARGET_DIR)/usr/share/kodi/addons
...
define KODI_RESOURCE_LANGUAGE_TR_TR_INSTALL_TARGET_CMDS
	@mkdir -p $(KODI_RESOURCE_LANGUAGE_TR_TR_DIR)
	@cp -r $(@D)/$(KODI_RESOURCE_LANGUAGE_TR_TR_PLUGINNAME) $(KODI_RESOURCE_LANGUAGE_TR_TR_DIR)
endef
