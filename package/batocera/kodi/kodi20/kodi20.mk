...
KODI20_VERSION_MAJOR = 20.1
KODI20_VERSION_NAME = Nexus
#KODI20_VERSION = $(KODI20_VERSION_MAJOR)-$(KODI20_VERSION_NAME)
KODI20_VERSION = bd0f7dc6632de5a76fb5e144d7055f016ad498ee
...
KODI20_CONF_OPTS += \
	...
	-DSWIG_EXECUTABLE=$(HOST_DIR)/bin/swig \
...
KODI20_CONF_OPTS += -DENABLE_LIRCCLIENT=ON
endif
...
KODI20_CONF_OPTS += -DENABLE_ALSA=ON -DENABLE_PULSEAUDIO=OFF -DENABLE_PIPEWIRE=OFF
# ifeq ($(BR2_PACKAGE_PIPEWIRE),y)
# KODI20_CONF_OPTS += -DENABLE_PIPEWIRE=ON -DENABLE_ALSA=OFF -DENABLE_PULSEAUDIO=OFF
# KODI20_DEPENDENCIES += pipewire
# else
# # Other audio support cannot be enabled with pipewire
