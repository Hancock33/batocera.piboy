...
KODI_RESOURCE_LANGUAGE_IT_IT_DIR=$(TARGET_DIR)/usr/share/kodi/addons
...
define KODI_RESOURCE_LANGUAGE_IT_IT_INSTALL_TARGET_CMDS
	@mkdir -p $(KODI_RESOURCE_LANGUAGE_IT_IT_DIR)
	@cp -r $(@D)/$(KODI_RESOURCE_LANGUAGE_IT_IT_PLUGINNAME) $(KODI_RESOURCE_LANGUAGE_IT_IT_DIR)
endef
