...
define UBOOT_VISIONFIVE2_INSTALL_TARGET_CMDS
	...
	cp $(UBOOT_VISIONFIVE2_DL_DIR)/u-boot-spl.bin.normal.out $(BINARIES_DIR)/uboot-visionfive2/u-boot-spl.bin.normal.out
	cp $(UBOOT_VISIONFIVE2_DL_DIR)/visionfive2_fw_payload.img $(BINARIES_DIR)/uboot-visionfive2/visionfive2_fw_payload.img
endef
