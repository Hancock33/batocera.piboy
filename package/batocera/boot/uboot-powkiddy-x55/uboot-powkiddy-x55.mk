...
UBOOT_POWKIDDY_X55_EXTRA_DOWNLOADS = https://github.com/rockchip-linux/rkbin/archive/$(UBOOT_POWKIDDY_X55_RKBIN_COMMIT)/rkbin-$(UBOOT_POWKIDDY_X55_RKBIN_COMMIT).tar.gz
...
define UBOOT_POWKIDDY_X55_EXTRACT_RKBIN
	mkdir -p $(@D)/rkbin
	$(TAR) -xf $(UBOOT_POWKIDDY_X55_DL_DIR)/rkbin-$(UBOOT_POWKIDDY_X55_RKBIN_COMMIT).tar.gz -C $(@D)/rkbin --strip-components=1
endef
