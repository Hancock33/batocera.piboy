...
UBOOT_ODROID_M1S_RKBIN_URL = https://github.com/rockchip-linux/rkbin/archive/$(UBOOT_ODROID_M1S_RKBIN_COMMIT)
UBOOT_ODROID_M1S_EXTRA_DOWNLOADS = $(UBOOT_ODROID_M1S_RKBIN_URL)/rkbin-$(UBOOT_ODROID_M1S_RKBIN_COMMIT).tar.gz
...
define UBOOT_ODROID_M1S_CONFIGURE_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) -C $(@D) $(UBOOT_ODROID_M1S_MAKE_OPTS) odroid-m1s-rk3566_defconfig
endef
...
define UBOOT_ODROID_M1S_INSTALL_IMAGES_CMDS
	...
	$(INSTALL) -D -m 0644 $(@D)/u-boot-rockchip.bin $(BINARIES_DIR)/uboot-odroid-m1s/u-boot-rockchip.bin
endef
