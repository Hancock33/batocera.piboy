...
UBOOT_ANBERNIC_RGXX3_RKBIN_URL = https://github.com/rockchip-linux/rkbin/archive/$(UBOOT_ANBERNIC_RGXX3_RKBIN_COMMIT)
UBOOT_ANBERNIC_RGXX3_EXTRA_DOWNLOADS = $(UBOOT_ANBERNIC_RGXX3_RKBIN_URL)/rkbin-$(UBOOT_ANBERNIC_RGXX3_RKBIN_COMMIT).tar.gz
...
define UBOOT_ANBERNIC_RGXX3_CONFIGURE_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) -C $(@D) $(UBOOT_ANBERNIC_RGXX3_MAKE_OPTS) anbernic-rgxx3-rk3566_defconfig
endef
