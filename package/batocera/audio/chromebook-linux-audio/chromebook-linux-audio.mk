...
CHROMEBOOK_LINUX_AUDIO_VERSION = d244d144d2a410f2fad23d25446c401096d0ce8e
...
define CHROMEBOOK_LINUX_AUDIO_INSTALL_TARGET_CMDS
	...
	cp -f $(@D)/conf/avs/51-avs-dmic.conf             $(TARGET_DIR)/etc/wireplumber/wireplumber.conf.d/51-avs-dmic.conf
endef
