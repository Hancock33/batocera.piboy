...
NVIDIA340_LEGACY_DRIVER_SITE = http://download.nvidia.com/XFree86/Linux-x86$(NVIDIA340_LEGACY_DRIVER_SUFFIX)/$(NVIDIA340_LEGACY_DRIVER_VERSION)
NVIDIA340_LEGACY_DRIVER_SOURCE = NVIDIA-Linux-x86$(NVIDIA340_LEGACY_DRIVER_SUFFIX)-$(NVIDIA340_LEGACY_DRIVER_VERSION).run
