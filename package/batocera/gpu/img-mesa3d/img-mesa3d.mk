...
IMG_MESA3D_CONF_OPTS += -Dglx=dri -Dglx-direct=true
...
IMG_MESA3D_CONF_OPTS += -Dglx=disabled -Dgallium-xa=disabled
endif
...
IMG_MESA3D_CONF_OPTS += -Dgallium-drivers= -Dgallium-extra-hud=false
else
IMG_MESA3D_CONF_OPTS += -Dshared-glapi=enabled \
