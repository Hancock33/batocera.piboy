...
BATOCERA_NVIDIA340_LEGACY_DRIVER_SOURCE = NVIDIA-Linux-x86$(BATOCERA_NVIDIA340_LEGACY_DRIVER_SUFFIX)-$(BATOCERA_NVIDIA340_LEGACY_DRIVER_VERSION).run
...
# BATOCERA_NVIDIA340_LEGACY_DRIVER_PROVIDES = libgl libegl libgles
...
BATOCERA_NVIDIA340_LEGACY_DRIVER_X_MODS = \
	/nvidia_drv.so \
	libnvidia-wfb.so.$(BATOCERA_NVIDIA340_LEGACY_DRIVER_VERSION)
endif # X drivers
...
BATOCERA_NVIDIA340_LEGACY_DRIVER_LIBS += \
	...
	libnvidia-fatbinaryloader.so.$(BATOCERA_NVIDIA340_LEGACY_DRIVER_VERSION) \
	libnvidia-ptxjitcompiler.so.$(BATOCERA_NVIDIA340_LEGACY_DRIVER_VERSION) \
...
define BATOCERA_NVIDIA340_LEGACY_DRIVER_EXTRACT_CMDS
	$(SHELL) $(BATOCERA_NVIDIA340_LEGACY_DRIVER_DL_DIR)/$(BATOCERA_NVIDIA340_LEGACY_DRIVER_SOURCE) --extract-only --target \
		$(@D)/tmp-extract
	chmod u+w -R $(@D)
...
# define BATOCERA_NVIDIA340_LEGACY_DRIVER_INSTALL_STAGING_CMDS
# 	$(call BATOCERA_NVIDIA340_LEGACY_DRIVER_INSTALL_LIBS,$(STAGING_DIR))
# 	$(BATOCERA_NVIDIA340_LEGACY_DRIVER_INSTALL_GL_DEV)
# endef
