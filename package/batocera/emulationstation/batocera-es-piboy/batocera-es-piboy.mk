...
BATOCERA_ES_PIBOY_VERSION = d3a72a65c10079a327d90651c9e884d0ae816461
...
BATOCERA_ES_PIBOY_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(TARGET_CFLAGS) -D$(call UPPERCASE,$(BATOCERA_ARCH))"
...
BATOCERA_ES_PIBOY_CONF_OPTS += -DGLES3=ON
