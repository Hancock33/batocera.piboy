...
BATOCERA_EMULATIONSTATION_VERSION = c3d5c6737b5e0c5847d9a14dbac718d773ce92cc
...
BATOCERA_EMULATIONSTATION_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(TARGET_CFLAGS) -fpermissive -D$(call UPPERCASE,$(BATOCERA_SYSTEM_ARCH))"
