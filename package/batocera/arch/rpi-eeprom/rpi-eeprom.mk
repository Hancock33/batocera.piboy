...
RPI_EEPROM_VERSION = e4f90a89e62051ff658c40c57150d13c7e67553b
...
define RPI_EEPROM_INSTALL_TARGET_CMDS
	...
	cp -pvr $(@D)/firmware/stable/{pieeprom-2022-08-02.bin,recovery.bin,vl805-000137ad.bin,vl805-000138a1.bin} \
