...
#
################################################################################
# Version.: Commits on Jul 26, 2022 (xorg)
...
define SONIC2013_POST_PROCESS
	...
	cp -f $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/ports/sonic/sonic2013/sonic2013.sonicretro.keys $(TARGET_DIR)/usr/share/evmapy
endef
