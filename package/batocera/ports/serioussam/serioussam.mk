...
SERIOUSSAM_VERSION = 7f0c60eb7e0dea667c5810f7f52346d9e2692490
...
SERIOUSSAM_DEPENDENCIES = sdl2 sdl2_mixer host-samtfe host-ninja
SERIOUSSAM_LICENSE = GPL-2.0

HOST_SERIOUSSAM_CONF_OPTS += -DCMAKE_BUILD_TYPE=Release
...
SERIOUSSAM_CONF_OPTS += -DCMAKE_BUILD_TYPE=Release 
