...
OPENJK_VERSION = 995d0dd461ce41755cb54dc78059cd42aeef0445
...
OPENJK_CONF_OPTS += -DCMAKE_BUILD_TYPE=Release -GNinja
#Single player
...
define OPENJK_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(BR2_CMAKE) --build $(OPENJK_BUILDDIR)
endef
