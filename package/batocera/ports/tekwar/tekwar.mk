...
define TEKWAR_BUILD_CMDS
		...
		CFLAGS="-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -Os -w -pipe -fsigned-char -D_FORTIFY_SOURCE=1" \
		CXXFLAGS="-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -Os -w -pipe -fsigned-char -D_FORTIFY_SOURCE=1" \
