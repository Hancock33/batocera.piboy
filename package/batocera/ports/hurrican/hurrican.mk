...
HURRICAN_VERSION = a7098c899f41c16ccae2e7b555ddcf9f9b07680c
HURRICAN_SITE = https://github.com/drfiemost/Hurrican.git

HURRICAN_DEPENDENCIES = sdl2 sdl2_mixer sdl2_image libepoxy host-ninja
...
HURRICAN_CONF_OPTS += -DCMAKE_BUILD_TYPE=Release $(@D)/Hurrican -DRENDERER=GLES2  -GNinja

define HURRICAN_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(BR2_CMAKE) --build $(HURRICAN_BUILDDIR)
endef
