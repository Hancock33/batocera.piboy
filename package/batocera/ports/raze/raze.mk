...
RAZE_VERSION = 25460e8e987326d85c48b1a1b1e63898af400d98
...
RAZE_CONF_OPTS += -DCMAKE_RULE_MESSAGES=OFF
RAZE_CONF_OPTS += -DCMAKE_C_FLAGS_RELEASE="-DNDEBUG"
RAZE_CONF_OPTS += -DCMAKE_CXX_FLAGS_RELEASE="-DNDEBUG"
