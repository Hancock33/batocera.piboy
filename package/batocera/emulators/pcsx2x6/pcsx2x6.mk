...
PCSX2X6_VERSION = 88d490bb1371dda3176078c6d3b3f6527ef545af
...
PCSX2X6_CONF_OPTS += -DUSE_DISCORD_PRESENCE=OFF
PCSX2X6_CONF_OPTS += -DLTO_PCSX2_CORE=OFF
...
define PCSX2X6_INSTALL_TARGET_CMDS
	mkdir -p $(TARGET_DIR)/usr/bin/pcsx2x6
	$(INSTALL) -m 0755 -D $(@D)/buildroot-build/bin/pcsx2-qt $(TARGET_DIR)/usr/bin/pcsx2x6/pcsx2x6-qt
	cp -pr  $(@D)/buildroot-build/bin/resources $(TARGET_DIR)/usr/bin/pcsx2x6
	# use our SDL config
	rm $(TARGET_DIR)/usr/bin/pcsx2x6/resources/game_controller_db.txt
endef
