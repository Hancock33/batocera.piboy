...
#
################################################################################
# Version: Commits on Dec 22, 2015
...
PIFBA_CFLAGS=$(TARGET_CFLAGS) -Wall -W -Wno-write-strings -O3 -DOOPSWARE_FIX -D_T="" -DNEOGEO_HACKS -D__cdecl="" \
	-D__fastcall="" -DUSE_SPEEDHACKS -DNEO_DISPLAY_OVERSCAN -falign-functions=32 -falign-loops -falign-labels -falign-jumps \
	-fomit-frame-pointer -ffast-math -fexpensive-optimizations -finline -finline-functions -mstructure-size-boundary=32 -frename-registers

PIFBA_CXXFLAGS=$(TARGET_CXXFLAGS) -DQWS -fno-exceptions -fno-rtti -Wall -W -Wno-write-strings -O3 -DOOPSWARE_FIX -D_T="" -DNEOGEO_HACKS \
	-D__cdecl="" -D__fastcall="" -DUSE_SPEEDHACKS -DNEO_DISPLAY_OVERSCAN -falign-functions=32 -falign-loops -falign-labels -falign-jumps \
	-fomit-frame-pointer -ffast-math -fexpensive-optimizations -finline -finline-functions -mstructure-size-boundary=32 -frename-registers
...
PIFBA_INCLUDES=-I$(STAGING_DIR)/usr/include -I$(STAGING_DIR)/usr/include/interface/vcos/pthreads \
	-I$(STAGING_DIR)/usr/include/interface/vmcs_host/linux $(PIFBA_SDL_FLAGS) \
...
define PIFBA_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) CFLAGS="$(PIFBA_CFLAGS)" CXXFLAGS="$(PIFBA_CXXFLAGS)" CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" \
		INCPATH="$(PIFBA_INCLUDES)" LINK="$(TARGET_CXX)" LIBS="$(PIFBA_LIBS)" -C $(@D)
endef
