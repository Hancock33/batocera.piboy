...
ifeq ($(BR2_arm)$(BR2_aarch64),y)
 ...
 YABAUSESA_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS) -D_POSIX_C_SOURCE=199309L -D__RP64__"
 YABAUSESA_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(TARGET_CFLAGS) -D_POSIX_C_SOURCE=199309L -D__RP64__"
else ifeq ($(BR2_x86_64),y)
  YABAUSESA_CONF_OPTS += -DYAB_WANT_DYNAREC_DEVMIYAX=OFF
  YABAUSESA_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS) -D_POSIX_C_SOURCE=199309L -D__PC__"
  YABAUSESA_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(TARGET_CFLAGS) -D_POSIX_C_SOURCE=199309L -D__PC__"
endif
