...
SIMCOUPE_VERSION = 5665a50bf06bd9f40e1962acc70a04ff15f1e079
...
SIMCOUPE_CONF_OPTS += -DCMAKE_BUILD_TYPE=Release -GNinja
...
define SIMCOUPE_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(BR2_CMAKE) --build $(SIMCOUPE_BUILDDIR)
endef
