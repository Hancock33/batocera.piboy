...
define XEMU_GET_SUBMODULES
	...
	curl -L -o volk.tar.gz \
		https://github.com/zeux/volk/archive/refs/tags/vulkan-tmp-1.4.349.0.tar.gz
	...
	curl -L -o SPIRV-Reflect.tar.gz \
		https://github.com/KhronosGroup/SPIRV-Reflect/archive/refs/tags/vulkan-tmp-1.4.349.0.tar.gz
