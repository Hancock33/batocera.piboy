...
#
################################################################################
# Version: Commits on Jul 8, 2024
WINE_CUSTOM_VERSION = 6e3dcf6c5877867b98b0d01b85206fba780c39c9
...
ifeq ($(BR_WINE_STAGING),y)
	WINE_CUSTOM_STAGING_VERSION = e479cad86f1f7de5d2a0a0d1398e7733c0aaef3e
