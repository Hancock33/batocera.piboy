...
ifeq ($(BR_CMAKE_USE_CLANG),y)
	HOST_WINE_NATIVE_DEPENDENCIES += host-clang host-lld
endif
...
WINE_NATIVE_CONF_OPTS += --with-osmesa
WINE_NATIVE_DEPENDENCIES += mesa3d
else
WINE_NATIVE_CONF_OPTS += --without-osmesa
endif
