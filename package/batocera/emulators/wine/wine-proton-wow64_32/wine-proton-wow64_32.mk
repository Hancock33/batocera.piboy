...
#
################################################################################
# Version: Commits on Dec 14, 2023 (branch@bleeding-edge)
WINE_PROTON_WOW64_32_VERSION = 666bf04c550442f534909efd81fd76d177253fe4
WINE_PROTON_WOW64_32_SOURCE = $(WINE_PROTON_WOW64_32_VERSION).tar.gz
WINE_PROTON_WOW64_32_SITE = $(call github,ValveSoftware,wine,$(TSUGARU_VERSION))
...
WINE_PROTON_WOW64_32_SELINUX_MODULES = wine
WINE_PROTON_WOW64_32_DEPENDENCIES = host-bison host-flex host-wine-proton
HOST_WINE_PROTON_WOW64_32_DEPENDENCIES = host-bison host-flex host-clang host-lld
...
WINE_PROTON_WOW64_32_CONF_OPTS += --with-usb
WINE_PROTON_WOW64_32_DEPENDENCIES += libusb
else
WINE_PROTON_WOW64_32_CONF_OPTS += --without-usb
endif

ifeq ($(BR2_PACKAGE_LIBV4L),y)
WINE_PROTON_WOW64_32_CONF_OPTS += --with-v4l2
WINE_PROTON_WOW64_32_DEPENDENCIES += libv4l
else
WINE_PROTON_WOW64_32_CONF_OPTS += --without-v4l2
endif
