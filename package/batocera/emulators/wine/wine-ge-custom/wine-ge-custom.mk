...
WINE_GE_CUSTOM_VERSION = 232b18d820e08fe6534249a64d3afdbf35d0b688
...
ifeq ($(BR_WINE_STAGING),y)
	WINE_GE_CUSTOM_STAGING_VERSION = f76a6ab8dad86c024991d70625e1d8460e096c0f
	HOST_WINE_GE_CUSTOM_EXTRA_DOWNLOADS = https://github.com/wine-staging/wine-staging/archive/$(WINE_GE_CUSTOM_STAGING_VERSION).tar.gz
	WINE_GE_CUSTOM_POST_EXTRACT_HOOKS += WINE_GE_CUSTOM_STAGING
	HOST_WINE_GE_CUSTOM_POST_EXTRACT_HOOKS += WINE_GE_CUSTOM_STAGING
endif

define WINE_GE_CUSTOM_STAGING
	# Use Staging Patches
	...
	cd $(@D); ./wine-staging-$(subst v,,$(WINE_GE_CUSTOM_STAGING_VERSION))/staging/patchinstall.py --all
endef
