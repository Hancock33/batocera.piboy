...
VKD3D_PROTON_VERSION = d97b5d23e65f16119b5a7893680ff655ec512981
...
define VKD3D_PROTON_EXTRACT_CMDS
	mkdir -p $(@D)/target && cd $(@D)/target && $(HOST_DIR)/bin/zstd -cd $(DL_DIR)/$(VKD3D_PROTON_DL_SUBDIR)/$(VKD3D_PROTON_SOURCE) | tar xf -
endef
