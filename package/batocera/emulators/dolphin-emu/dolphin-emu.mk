...
DOLPHIN_EMU_VERSION = 74c5ca79e2caa986b22d4368dd85398e0b4e09e3
DOLPHIN_EMU_VERSION_MAJOR = 2512
DOLPHIN_EMU_VERSION_MINOR = 105
...
DOLPHIN_EMU_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS) -flto -funroll-loops -fprefetch-loop-arrays -fno-exceptions -fno-rtti"
DOLPHIN_EMU_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(TARGET_CXXFLAGS) -flto -funroll-loops -fprefetch-loop-arrays -fno-exceptions -fno-rtti"
