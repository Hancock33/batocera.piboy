...
RETROCRISIS_SOURCE = Retro.Crisis.GDV-NTSC.$(RETROCRISIS_DATE).zip.zip
...
define RETROCRISIS_INSTALL_TARGET_CMDS
	...
	cp -ar $(@D)/retro* $(TARGET_DIR)/usr/share/batocera/shaders/retrocrisis
endef
