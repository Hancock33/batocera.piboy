...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_X86)$(BR2_PACKAGE_BATOCERA_TARGET_X86_64_ANY),y)
...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BCM2836)$(BR2_PACKAGE_BATOCERA_TARGET_BCM2837),y)
...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3588)$(BR2_PACKAGE_BATOCERA_TARGET_RK3588_SDIO)$(BR2_PACKAGE_BATOCERA_TARGET_RK3588_MAINLINE),y)
    ...
    BATOCERA_GPU_SYSTEM=adreno-643
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_SM6115),y)
    BATOCERA_GPU_SYSTEM=adreno-610
    ...
    BATOCERA_GPU_SYSTEM=adreno-830
endif
