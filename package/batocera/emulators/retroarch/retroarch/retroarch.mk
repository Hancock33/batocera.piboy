...
RETROARCH_VERSION = e15bd1dcb93048e8ef9b7c758e45f070958158db
...
define RETROARCH_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC) -Wno-incompatible-pointer-types" LD="$(TARGET_LD)" -C $(@D)/ HAVE_BUILTINFLAC=1
...
endef
RETROARCH_POST_INSTALL_TARGET_HOOKS += RETROARCH_LIBRETRO_FFMPEG_INSTALL
endif
