...
LIBRETRO_FLYCAST2021_VERSION = v1.3
...
LIBRETRO_FLYCAST2021_CONF_OPTS = -DCMAKE_BUILD_TYPE=Release -DUSE_OPENMP=ON \
	-DLIBRETRO=ON -DBUILD_SHARED_LIBS=OFF \
	-DBUILD_EXTERNAL=ON -DWITH_SYSTEM_ZLIB=ON \
    -DGIT_VERSION="$(shell echo $(LIBRETRO_FLYCAST2021_VERSION) | cut -c 1-7)"
...
ifeq ($(BR2_PACKAGE_BATOCERA_RPI_VCORE),y)
    LIBRETRO_FLYCAST2021_CONF_OPTS += -DUSE_VIDEOCORE=ON
endif

ifeq ($(BR2_PACKAGE_HAS_LIBMALI),y)
    LIBRETRO_FLYCAST2021_CONF_OPTS += -DUSE_MALI=ON
endif

ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RG552),y)
    LIBRETRO_FLYCAST2021_CONF_OPTS += -DRG552=ON
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BCM2711),y)
    LIBRETRO_FLYCAST2021_CONF_OPTS += -DRPI4=ON
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3326),y)
    LIBRETRO_FLYCAST2021_CONF_OPTS += -DRK3326=ON
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_S922X),y)
    LIBRETRO_FLYCAST2021_CONF_OPTS += -DS922X=ON
endif
