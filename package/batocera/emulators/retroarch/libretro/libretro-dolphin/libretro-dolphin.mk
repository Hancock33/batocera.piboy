...
LIBRETRO_DOLPHIN_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS) -flto -funroll-loops -fprefetch-loop-arrays -fno-exceptions -fno-rtti"
LIBRETRO_DOLPHIN_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(TARGET_CXXFLAGS) -flto -funroll-loops -fprefetch-loop-arrays -fno-exceptions -fno-rtti"
