...
LIBRETRO_PANDA3DS_VERSION = 5aaa1d26565c834a6f1999026260e559f54aacf1
...
LIBRETRO_PANDA3DS_EMULATOR_INFO = panda3ds.libretro.core.yml
LIBRETRO_PANDA3DS_DEPENDENCIES = fdk-aac ffmpeg fmt lua

LIBRETRO_PANDA3DS_CONF_OPTS += -DCMAKE_C_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-gcc
LIBRETRO_PANDA3DS_CONF_OPTS += -DCMAKE_CXX_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-g++
LIBRETRO_PANDA3DS_CONF_OPTS += -DCMAKE_INTERPROCEDURAL_OPTIMIZATION=OFF
