...
LIBRETRO_PPSSPP_VERSION = e40ec0cc500853bcb08d18dc229a4aa827901eef
...
# use clang to build
LIBRETRO_PPSSPP_CONF_OPTS += -DCMAKE_C_COMPILER=$(HOST_DIR)/bin/clang
LIBRETRO_PPSSPP_CONF_OPTS += -DCMAKE_CXX_COMPILER=$(HOST_DIR)/bin/clang++
