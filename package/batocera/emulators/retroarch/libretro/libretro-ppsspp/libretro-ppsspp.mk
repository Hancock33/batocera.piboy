...
LIBRETRO_PPSSPP_VERSION = 38c4c48ebe3b00f1ce98f881ff45db2a3d7a26dd
...
LIBRETRO_PPSSPP_CONF_OPTS = -DCMAKE_BUILD_TYPE=Release -GNinja -DCMAKE_SYSTEM_NAME=Linux \
    -DBUILD_SHARED_LIBS=OFF -DLIBRETRO=ON -DANDROID=OFF -DWIN32=OFF -DAPPLE=OFF \
	-DUSE_FFMPEG=ON -DUSE_SYSTEM_FFMPEG=OFF -DUSE_DISCORD=OFF \
	-DUSING_FBDEV=OFF -DUNITTEST=OFF -DSIMULATOR=OFF
...
define LIBRETRO_PPSSPP_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(BR2_CMAKE) --build $(LIBRETRO_PPSSPP_BUILDDIR)
endef
