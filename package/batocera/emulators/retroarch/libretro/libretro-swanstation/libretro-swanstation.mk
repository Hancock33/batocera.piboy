...
LIBRETRO_SWANSTATION_VERSION = 9498be27f8cdde1244045ee7bd6f11922a8f7916
...
LIBRETRO_SWANSTATION_CONF_OPTS += -DCMAKE_C_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-gcc
LIBRETRO_SWANSTATION_CONF_OPTS += -DCMAKE_CXX_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-g++
