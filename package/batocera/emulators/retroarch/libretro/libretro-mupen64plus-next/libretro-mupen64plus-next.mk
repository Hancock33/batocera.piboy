...
LIBRETRO_MUPEN64PLUS_NEXT_VERSION = 98c1b0d877542b01314b3b04272282ba223b65b3
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BCM2711),y)
    ...
    LIBRETRO_MUPEN64PLUS_NEXT_EXTRA_ARGS += HAVE_PARALLEL_RSP=1
...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_QCS6490)$(BR2_PACKAGE_BATOCERA_TARGET_SM6115)$(BR2_PACKAGE_BATOCERA_TARGET_SM8250)$(BR2_PACKAGE_BATOCERA_TARGET_SM8550)$(BR2_PACKAGE_BATOCERA_TARGET_SM8750),y)
...
define LIBRETRO_MUPEN64PLUS_NEXT_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D $(@D)/mupen64plus_next_libretro.so $(TARGET_DIR)/usr/lib/libretro/mupen64plus-next_libretro.so
endef
