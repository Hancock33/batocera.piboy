...
LIBRETRO_PARALLEL_N64_VERSION = 51aefbd38751563138b5fee3810ff653a78c4f24
...
LIBRETRO_PARALLEL_N64_EMULATOR_INFO = parallel_n64.libretro.core.yml
...
define LIBRETRO_PARALLEL_N64_BUILD_CMDS
	...
	$(TARGET_CONFIGURE_OPTS) $(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC) -std=gnu17" -C $(@D)/ -f Makefile platform="$(LIBRETRO_PARALLEL_N64_PLATFORM)" \
...
define LIBRETRO_PARALLEL_N64_FIXUP
