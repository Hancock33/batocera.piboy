...
LIBRETRO_FLYCAST_VERSION = f590766421aeb9c3efcb61ff8f111957dd8c9a5f
LIBRETRO_FLYCAST_SOURCE = flycast-$(LIBRETRO_FLYCAST_VERSION)-br1.tar.gz
...
LIBRETRO_FLYCAST_DEPENDENCIES = retroarch host-ninja
LIBRETRO_FLYCAST_SUPPORTS_IN_SOURCE_BUILD = NO

LIBRETRO_FLYCAST_PLATFORM = $(LIBRETRO_PLATFORM)

LIBRETRO_FLYCAST_CONF_OPTS = -DCMAKE_BUILD_TYPE=Release -GNinja -DUSE_OPENMP=ON \
	-DLIBRETRO=ON -DBUILD_SHARED_LIBS=OFF \
	-DBUILD_EXTERNAL=ON -DWITH_SYSTEM_ZLIB=ON \
    -DGIT_VERSION="$(shell echo $(LIBRETRO_FLYCAST_VERSION) | cut -c 1-7)"
...
define LIBRETRO_FLYCAST_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(BR2_CMAKE) --build $(LIBRETRO_FLYCAST_BUILDDIR)
endef
