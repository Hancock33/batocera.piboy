...
LIBRETRO_FLYCAST_VERSION = 3b8e3113bbf45669fd5fef2a018ffe9b3ae0f6a6
...
LIBRETRO_FLYCAST_PLATFORM = rpi4_64-neon
LIBRETRO_FLYCAST_EXTRA_ARGS += FORCE_GLES=1 ARCH=arm64 LDFLAGS=-lrt

else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RPI3)$(BR2_PACKAGE_BATOCERA_TARGET_RPIZERO2),y)
    ifeq ($(BR2_arm),y)
        LIBRETRO_FLYCAST_PLATFORM = rpi3-neon
    else
        LIBRETRO_FLYCAST_PLATFORM = rpi3_64-neon
    endif
    LIBRETRO_FLYCAST_EXTRA_ARGS += FORCE_GLES=1 ARCH=arm64 LDFLAGS=-lrt

else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_XU4),y)
LIBRETRO_FLYCAST_PLATFORM = odroid
LIBRETRO_FLYCAST_EXTRA_ARGS += BOARD=ODROID-XU4 FORCE_GLES=1 ARCH=arm LDFLAGS=-lrt
...
LIBRETRO_FLYCAST_PLATFORM = mali-drm-gles2
LIBRETRO_FLYCAST_EXTRA_ARGS += ARCH=arm64 FORCE_GLES=1 LDFLAGS=-lrt
...
define LIBRETRO_FLYCAST_BUILD_CMDS
    $(TARGET_CONFIGURE_OPTS) $(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" -C $(@D)/ -f Makefile \
        ...
        GIT_VERSION="-$(shell echo $(LIBRETRO_FLYCAST_VERSION) | cut -c 1-7)"
endef
