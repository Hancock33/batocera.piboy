...
LIBRETRO_LOWRESNX_VERSION = c824ec163a1945cc48e4319054c7eb1024667497
...
LIBRETRO_LOWRESNX_CONFIGURE_OPTS = GIT_DISCOVERY_ACROSS_FILESYSTEM=1 platform=$(LIBRETRO_LOWRESNX_PLATFORM)
...
define LIBRETRO_LOWRESNX_BUILD_CMDS
	...
	$(LOWRESNS_CONFIGURE_OPTS) $(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" -C $(@D)/platform/LibRetro -f Makefile \
		...
		$(LIBRETRO_LOWRESNX_CONFIGURE_OPTS)
endef
