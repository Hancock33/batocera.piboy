...
LIBRETRO_BEETLE_PCFX_VERSION = c1650bad5fbdcc3c3ccd45e29e3983e1ccf16cff
...
LIBRETRO_BEETLE_PCFX_EMULATOR_INFO = pcfx.libretro.core.yml
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_S922X)$(BR2_PACKAGE_BATOCERA_TARGET_A3GEN2),y)
    ...
    LIBRETRO_BEETLE_PCFX_PLATFORM = S905
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_H616)$(BR2_PACKAGE_BATOCERA_TARGET_H6)$(BR2_PACKAGE_BATOCERA_TARGET_H700),y)
    LIBRETRO_BEETLE_PCFX_PLATFORM = S905
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3576)$(BR2_PACKAGE_BATOCERA_TARGET_RK3568)$(BR2_PACKAGE_BATOCERA_TARGET_RK3562)$(BR2_PACKAGE_BATOCERA_TARGET_S905GEN3),y)
    LIBRETRO_BEETLE_PCFX_PLATFORM = SM1
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3588)$(BR2_PACKAGE_BATOCERA_TARGET_RK3588_SDIO)$(BR2_PACKAGE_BATOCERA_TARGET_RK3588_MAINLINE)$(BR2_PACKAGE_BATOCERA_TARGET_T527),y)
...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_QCS6490)$(BR2_PACKAGE_BATOCERA_TARGET_SM8250)$(BR2_PACKAGE_BATOCERA_TARGET_SM8550),y)
