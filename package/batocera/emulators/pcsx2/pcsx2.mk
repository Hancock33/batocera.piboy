...
PCSX2_VERSION = 46f6e691e01bf4e51b2b29532e998d5e5ea2428e
...
PCSX2_DEPENDENCIES += libsamplerate fmt qt6base qt6tools qt6svg
...
PCSX2_CONF_OPTS += -DCMAKE_C_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-gcc
PCSX2_CONF_OPTS += -DCMAKE_CXX_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-g++
