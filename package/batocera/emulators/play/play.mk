...
#
################################################################################
# Version: Commits on Mar 27, 2023
PLAY_VERSION = 8e1cc18be61f5baac0c78b9eeeb2f75d196217a5
...
PLAY_CONF_OPTS += -DCMAKE_C_FLAGS="-O3 -pipe -fpic"
PLAY_CONF_OPTS += -DCMAKE_CXX_FLAGS="-O3 -pipe  -fpic"
