...
ifeq ($(BR2_arm)$(BR2_aarch64),y)
	...
	YABASANSHIRO_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS) $(YABASANSHIRO_TARGET_CFLAGS) -D_POSIX_C_SOURCE=199309L -DNDEBUG -D__RP64__"
	...
	YABASANSHIRO_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS) $(YABASANSHIRO_TARGET_CFLAGS) -D_POSIX_C_SOURCE=199309L -DNDEBUG -D__PC__"
