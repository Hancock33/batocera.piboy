...
RPCS3_VERSION = 77485747f19b22a6f4c935b8f04cb1f690a85227
...
RPCS3_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS)"
RPCS3_CONF_OPTS += -DCMAKE_C_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-gcc
RPCS3_CONF_OPTS += -DCMAKE_CXX_COMPILER=$(HOST_DIR)/bin/$(GNU_TARGET_NAME)-g++
