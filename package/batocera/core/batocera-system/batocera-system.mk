...
BATOCERA_SYSTEM_VERSION = 33-Dev-PiBoy
...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_GAMEFORCE),y)
	BATOCERA_SYSTEM_ARCH=gameforce
	BATOCERA_SYSTEM_BATOCERA_CONF=gameforce
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_PIBOY4),y)
	BATOCERA_SYSTEM_ARCH=rpi4
	BATOCERA_SYSTEM_BATOCERA_CONF=piboy4
else ($(BR2_PACKAGE_BATOCERA_TARGET_PIBOY3),y)
	BATOCERA_SYSTEM_ARCH=rpi3
	BATOCERA_SYSTEM_BATOCERA_CONF=piboy3
else
