...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BCM2837),y)
    ...
    BATOCERA_SYSTEM_ARCH=rk3588-mainline
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_SDM845),y)
    BATOCERA_SYSTEM_ARCH=sdm845
