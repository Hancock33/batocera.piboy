...
BATOCERA_SCRIPTS_CP_PATH = $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-scripts
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_SM6115),y)
  BATOCERA_SCRIPTS_POST_INSTALL_TARGET_HOOKS += BATOCERA_SCRIPTS_INSTALL_MANGMI
endif

ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3588_MAINLINE),y)
  BATOCERA_SCRIPTS_POST_INSTALL_TARGET_HOOKS += BATOCERA_SCRIPTS_INSTALL_RK3588
endif
...
define BATOCERA_SCRIPTS_INSTALL_TARGET_CMDS
	...
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-part                          $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-planemode                     $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-power-mode                    $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-save-overlay                  $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-services                      $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-shutdown                      $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-spinner-calibrator            $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-storage-manager               $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-storage-udev                  $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-store                         $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-streaming                     $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-support                       $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-switch-screen-checker         $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-switch-screen-checker-delayed $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-sync                          $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-systems                       $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-temp                          $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-timezone                      $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-upgrade                       $(TARGET_DIR)/usr/bin/
	...
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/getLocalWaylandDisplay                 $(TARGET_DIR)/usr/bin/
...
define BATOCERA_SCRIPTS_INSTALL_MOUSE
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-mouse.$(BATOCERA_SCRIPTS_MOUSE_TYPE) $(TARGET_DIR)/usr/bin/batocera-mouse
endef
...
define BATOCERA_SCRIPTS_INSTALL_MANGMI
    install -m 0755 $(BATOCERA_SCRIPTS_PATH)/scripts/mangmi_fan_control.py              $(TARGET_DIR)/usr/bin/
endef

define BATOCERA_SCRIPTS_INSTALL_RK3588
    install -m 0755 $(BATOCERA_SCRIPTS_PATH)/scripts/rk3588-fan                         $(TARGET_DIR)/usr/bin/
endef

define BATOCERA_SCRIPTS_INSTALL_ROCKCHIP
	mkdir -p $(TARGET_DIR)/usr/bin/
	install -m 0755 $(BATOCERA_SCRIPTS_CP_PATH)/scripts/batocera-rockchip-suspend $(TARGET_DIR)/usr/bin/
endef
