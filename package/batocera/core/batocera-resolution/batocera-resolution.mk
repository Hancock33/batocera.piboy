...
define BATOCERA_RESOLUTION_INSTALL_TOUCHSCREEN
	install -m 0755 $(BATOCERA_RESOLUTION_PATH)/touchscreen/S95touchscreen.$(BATOCERA_SCRIPT_TYPE) $(TARGET_DIR)/etc/init.d/S95touchscreen
endef
...
ifeq ($(BR2_PACKAGE_BATOCERA_WAYLAND_SWAY),y)
	BATOCERA_RESOLUTION_POST_INSTALL_TARGET_HOOKS += BATOCERA_RESOLUTION_INSTALL_TOUCHSCREEN
endif
