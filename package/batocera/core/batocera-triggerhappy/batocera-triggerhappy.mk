...
BATOCERA_TRIGGERHAPPY_SOURCE_PATH = $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-triggerhappy
...
define BATOCERA_TRIGGERHAPPY_INSTALL_RK3326_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/rk3326/*.conf $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef

define BATOCERA_TRIGGERHAPPY_INSTALL_RK3399_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/rk3399/*.conf $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef

define BATOCERA_TRIGGERHAPPY_INSTALL_RK3128_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/rk3128/*.conf $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef

define BATOCERA_TRIGGERHAPPY_INSTALL_X86_64_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/x86_64/*.conf $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef

define BATOCERA_TRIGGERHAPPY_INSTALL_SM8250_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/sm8250/*.conf $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef

define BATOCERA_TRIGGERHAPPY_INSTALL_SM8550_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/sm8550/*.conf $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef

define BATOCERA_TRIGGERHAPPY_INSTALL_S922X_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/s922x/*.conf \
	    $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef

define BATOCERA_TRIGGERHAPPY_INSTALL_RK3568_CONFIG
	cp -v $(BATOCERA_TRIGGERHAPPY_SOURCE_PATH)/conf/rk3568/*.conf \
	    $(TARGET_DIR)/etc/triggerhappy/triggers.d/
endef
