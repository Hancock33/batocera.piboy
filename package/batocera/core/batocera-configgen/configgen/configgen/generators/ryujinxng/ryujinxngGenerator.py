...
ryujinxConf = batoceraFiles.CONF + "/RyujinxNG"
...
class RyujinxNGGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        if rom == "config":
            commandArray = ["/usr/bin/ryujinx-ng/Ryujinx"]
        else:
            commandArray = ["/usr/bin/ryujinx-ng/Ryujinx", "--fullscreen", rom]
        ...
        return Command.Command(
            ...
            "QT_QPA_PLATFORM":"xcb", \
            "LD_LIBRARY_PATH": "/usr/bin/ryujinx-ng/:/usr/lib",
