...
def generateMAMEConfigs(playersControllers: Controllers, system: Emulator, rom: Path, guns: Guns) -> None:
    ...
    if system.name in [ 'mame', 'neogeo', 'lcdgames', 'tvgames', 'vis', 'namco22', 'namco2x6', 'model1', 'model2', 'model3', 'cave3rd', 'gaelco', 'hikaru'] or "/arcade/" in arcadepath:
