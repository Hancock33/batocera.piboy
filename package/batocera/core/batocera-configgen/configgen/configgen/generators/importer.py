...
_GENERATOR_MAP: Final[dict[str, tuple[str, str]]] = {
    ...
    'dosboxstaging': ('dosboxstaging.dosboxstagingGenerator', 'DosBoxStagingGenerator'),
    ...
    'dxx_rebirth': ('dxx_rebirth.dxx_rebirthGenerator', 'DXX_RebirthGenerator'),
    ...
    'fallout1': ('fallout1.fallout1Generator', 'Fallout1Generator'),
    'fallout2': ('fallout2.fallout2Generator', 'Fallout2Generator'),
    ...
    'hypseus_singe': ('hypseus_singe.hypseusSingeGenerator', 'HypseusSingeGenerator'),
    ...
    'mupen': ('mupen.mupenGenerator', 'MupenGenerator'),
    ...
    'sonic3_air': ('sonic3_air.sonic3_airGenerator', 'Sonic3AIRGenerator'),
    ...
    'sonicretro': ('sonicretro.sonicretroGenerator', 'SonicRetroGenerator'),
    'sonicretro': ('sonicretro.sonicretroGenerator', 'SonicRetroGenerator'),
