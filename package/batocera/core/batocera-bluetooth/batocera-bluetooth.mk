...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_RK3288),y) # tinkerboard only ??
...
define BATOCERA_BLUETOOTH_INSTALL_TARGET_CMDS
	...
	cp $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-bluetooth/S29namebluetooth $(TARGET_DIR)/etc/init.d/S29namebluetooth
