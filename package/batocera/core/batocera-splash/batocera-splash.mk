...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_S922X)$(BR2_PACKAGE_BATOCERA_TARGET_S905GEN3),y)
...
ifeq ($(BATOCERA_SPLASH_MEDIA),image)
    ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_GAMEFORCE)$(BR2_PACKAGE_BATOCERA_TARGET_RPI1)$(BR2_PACKAGE_BATOCERA_TARGET_RPIZERO2),y)
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_CHA),y)
	...
	BATO_SPLASH=$(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-splash/piboy.mp4
...
define BATOCERA_SPLASH_INSTALL_BOOT_PIBOY_LOGO
	mkdir -p $(TARGET_DIR)/usr/share/batocera/splash
	cp "$(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-splash/piboy-logo480p.png" "${TARGET_DIR}/usr/share/batocera/splash/boot-logo.png"
endef
