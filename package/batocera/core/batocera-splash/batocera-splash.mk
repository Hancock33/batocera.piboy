...
ifeq ($(BR2_PACKAGE_BATOCERA_SPLASH_MPV),y)
    ...
    else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_AMLOGIC_ANY)$(BR2_PACKAGE_BATOCERA_RPI_ANY)$(BR2_PACKAGE_BATOCERA_TARGET_RK3326)$(BR2_PACKAGE_BATOCERA_TARGET_RK3399)$(BR2_PACKAGE_BATOCERA_TARGET_RG552)$(BR2_PACKAGE_BATOCERA_TARGET_RK3128)$(BR2_PACKAGE_BATOCERA_TARGET_ORANGEPI_3_LTS)$(BR2_PACKAGE_BATOCERA_TARGET_ORANGEPI_ZERO2),y)
...
ifeq ($(BATOCERA_SPLASH_MEDIA),video)
	...
	ifeq ($(BR2_PACKAGE_XPI_GAMECON_RPI3)$(BR2_PACKAGE_XPI_GAMECON_RPI4),y)
	    BATOCERA_SPLASH_POST_INSTALL_TARGET_HOOKS += BATOCERA_SPLASH_INSTALL_BOOT_PIBOY_LOGO
    endif
	...
	else ifeq ($(BR2_PACKAGE_XPI_GAMECON_RPI3)$(BR2_PACKAGE_XPI_GAMECON_RPI4),y)
...
define BATOCERA_SPLASH_INSTALL_BOOT_PIBOY_LOGO
	mkdir -p $(TARGET_DIR)/usr/share/batocera/splash
	cp "$(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/core/batocera-splash/images/piboy-logo480p.png" "${TARGET_DIR}/usr/share/batocera/splash/boot-logo.png"
endef
