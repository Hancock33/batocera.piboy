...
ifeq ($(BR2_PACKAGE_BATOCERA_SPLASH_MPV),y)
    ...
    else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_AMLOGIC_ANY)$(BR2_PACKAGE_BATOCERA_RPI_ANY)$(BR2_PACKAGE_BATOCERA_TARGET_RK3326)$(BR2_PACKAGE_BATOCERA_TARGET_RK3399)$(BR2_PACKAGE_BATOCERA_TARGET_RK3128)$(BR2_PACKAGE_BATOCERA_TARGET_ORANGEPI_3_LTS)$(BR2_PACKAGE_BATOCERA_TARGET_ORANGEPI_ZERO2),y)
