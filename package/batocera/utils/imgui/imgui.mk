...
ifeq ($(BR2_PACKAGE_SDL3),y)
    ...
    IMGUI_CONF_OPTS += -DIMGUI_BUILD_SDL3_BINDING=ON
endif

ifeq ($(BR2_PACKAGE_HAS_LIBGL),y)
    IMGUI_CONF_OPTS += -DIMGUI_BUILD_OPENGL3_BINDING=ON
else ifeq ($(BR2_PACKAGE_HAS_LIBGLES),y)
    IMGUI_CONF_OPTS += -DIMGUI_BUILD_OPENGL3_BINDING=ON
endif

ifeq ($(BR2_PACKAGE_VULKAN_LOADER),y)
    IMGUI_DEPENDENCIES += vulkan-headers vulkan-loader
    IMGUI_CONF_OPTS += -DIMGUI_BUILD_VULKAN_BINDING=ON
endif
