...
define RPIGPIOSWITCH_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(RPIGPIOSWITCH_SRC)/S92switch								$(TARGET_DIR)/etc/init.d/S92switch
	...
	$(INSTALL) -D -m 0755 $(RPIGPIOSWITCH_SRC)/rpi-kintaro-SafeShutdown.py				$(TARGET_DIR)/usr/bin/rpi-kintaro-SafeShutdown
	$(INSTALL) -D -m 0755 $(RPIGPIOSWITCH_SRC)/S72gpioinput								$(TARGET_DIR)/etc/init.d/S72gpioinput
endef

# Add Retroflag dtbo for rpi2,3 & 4 boards only
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_BCM2836)$(BR2_PACKAGE_BATOCERA_TARGET_BCM2837)$(BR2_PACKAGE_BATOCERA_TARGET_BCM2711),y)
define RPIGPIOSWITCH_INSTALL_TARGET_CMDS_POST
	mkdir -p $(BINARIES_DIR)/retroflag/
	wget -O $(@D)/RetroFlag_pw_io.dtbo https://raw.githubusercontent.com/RetroFlag/retroflag-picase/master/RetroFlag_pw_io.dtbo
	$(INSTALL) -D -m 0644 $(@D)/RetroFlag_pw_io.dtbo $(BINARIES_DIR)/retroflag/
endef
