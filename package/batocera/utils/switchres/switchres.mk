...
define SWITCHRES_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0644 $(@D)/libswitchres.so.$(subst v,,$(SWITCHRES_VERSION))	$(TARGET_DIR)/usr/lib/libswitchres.so.$(subst v,,$(SWITCHRES_VERSION))
	ln -sf $(TARGET_DIR)/usr/lib/libswitchres.so.$(subst v,,$(SWITCHRES_VERSION))	$(TARGET_DIR)/usr/lib/libswitchres.so.2
