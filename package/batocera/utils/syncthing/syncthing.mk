...
SYNCTHING_VERSION = v2.0.0-beta.3
...
define SYNCTHING_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -Dm755 $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/utils/syncthing/syncthing $(TARGET_DIR)/usr/share/batocera/services/
endef
