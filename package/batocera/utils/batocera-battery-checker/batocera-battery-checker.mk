...
define BATOCERA_BATTERY_CHECKER_INSTALL_TARGET_CMDS
	...
	install -m 0755 $(CHECKER_PATH)/batocera-battery-checker			$(TARGET_DIR)/usr/bin/batocera-battery-checker
	install -m 0755 $(CHECKER_PATH)/batocera-battery-checker.service	$(TARGET_DIR)/etc/init.d/S90battery_checker
endef
