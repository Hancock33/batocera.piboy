...
define UBOOT_POWKIDDY_X55_CONFIGURE_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) -C $(@D) $(UBOOT_POWKIDDY_X55_MAKE_OPTS) powkiddy-x55-rk3566_defconfig
endef
...
define UBOOT_POWKIDDY_X55_INSTALL_IMAGES_CMDS
	...
	$(INSTALL) -D -m 0644 $(@D)/u-boot-rockchip.bin $(BINARIES_DIR)/uboot-powkiddy-x55/u-boot-rockchip.bin
endef
