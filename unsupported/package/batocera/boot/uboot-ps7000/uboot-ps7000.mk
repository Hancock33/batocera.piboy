...
UBOOT_PS7000_VERSION = e2c76fb6b0f89c5385273b3a83fbd2ce16903396
...
define UBOOT_PS7000_BUILD_CMDS
	...
	cd $(@D) && ARCH=arm CHIP=rk3128 CROSS_COMPILE=$(HOST_DIR)/bin/arm-buildroot-linux-gnueabihf- make ps7000-rk3128_defconfig
