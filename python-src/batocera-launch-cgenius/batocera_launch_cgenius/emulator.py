...
class CGenius(Emulator):
    ...
    async def configure(self) -> Command:
        ...
        for engine_section in ('Launcher', 'Vorticon', 'Galaxy', 'Cosmos'):
            if engine_section not in config:
                config[engine_section] = {}
            config[engine_section]['gameWidth'] = game_width
            config[engine_section]['gameHeight'] = game_height
